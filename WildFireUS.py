...
memory usage: 342.5+ MB'''
    ...
    with tab3:
        ...
        if option_Stat == "Analyse univariée: Causes des feux de forêt":
            ...
            st.write("")
            st.write("")
            df1 = pd.read_csv('C:/Users/yj1015/Desktop/COMPLET/ANOVA1.csv')
            st.table(df1)
            ...
            st.write("")
            st.write("")
            df2 = pd.read_csv('C:/Users/yj1015/Desktop/COMPLET/ANOVA2.csv')
            st.table(df2)
...
2 	    1345 	33854 	    14587'''
    ...
    # Code for Conclusion page
>>>>>>> c5253ec (Track large files with Git LFS)
    pass